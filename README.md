Bu proje, öğrencilerin yönetimi için geliştirilmiş bir web uygulamasıdır. Hem öğrenci hem de yönetici arayüzleri sunarak, kullanıcıların sisteme giriş yapmalarını, oturum açmalarını sağlar.
